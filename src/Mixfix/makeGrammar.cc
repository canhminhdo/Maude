...
MixfixModule::makeStrategyLanguageProductions() {
    ...
    }
    {
        ...
        rhs[2] = SUCH_THAT;
        rhs[3] = CONDITION;
        parser->insertProduction(STRATEGY_EXPRESSION, rhs, STRAT_TEST_PREC, gatherAnyAnyAny, MixfixParser::MAKE_TEST,
                                 -1);
        rhs[0] = xmatch;
        parser->insertProduction(STRATEGY_EXPRESSION, rhs, STRAT_TEST_PREC, gatherAnyAnyAny, MixfixParser::MAKE_TEST,
                                 0);
        ...
        rhs[0] = amatch;
        parser->insertProduction(STRATEGY_EXPRESSION, rhs, STRAT_TEST_PREC, gatherAny, MixfixParser::MAKE_TEST,
                                 UNBOUNDED);
    }
    {
    ...
    }
    {
        ...
        rhs[0] = amatchrew;
        parser->insertProduction(STRATEGY_EXPRESSION, rhs, STRAT_REW_PREC, gatherAny4, MixfixParser::MAKE_REW,
                                 UNBOUNDED);
        rhs.resize(4);
        rhs[0] = matchrew;
        rhs[2] = by;
        ...
        rhs[0] = amatchrew;
        parser->insertProduction(STRATEGY_EXPRESSION, rhs, STRAT_REW_PREC, gatherAnyAny, MixfixParser::MAKE_REW,
                                 UNBOUNDED);
    }
    {
        //
