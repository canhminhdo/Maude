...
ImportModule::addParameter(const Token parameterName,
    ...
    WarningCheck(canHaveAsParameter(getModuleType(), t),
                 LineNumber(parameterName.lineNumber()) << ": parameterization of " <<
                                                        QUOTE(moduleTypeString(getModuleType())) << " " <<
                                                        QUOTE(this) << " by parameter " << QUOTE(parameterName)
                                                        << " of " <<
                                                        QUOTE(moduleTypeString(t)) << " " <<
...
ImportModule::importSorts() {
    ...
    {
        FOR_EACH_CONST(i, Vector<ImportModule *>, parameterTheories)(*i)->donateSorts(this);
    }
    //
    ...
    //
    {
        FOR_EACH_CONST(i, Vector<ImportModule *>, importedModules)(*i)->donateSorts(this);
    }
    //
...
ImportModule::donateSorts(ImportModule *importer) {
    ...
    //	must be bound.
    //
    FOR_EACH_CONST(i, Vector<ImportModule *>, importedModules)(*i)->donateSorts(importer);
    //
...
ImportModule::importOps() {
    ...
    {
        FOR_EACH_CONST(i, Vector<ImportModule *>, parameterTheories)(*i)->donateOps(this);
    }
    //
    ...
    //
    {
        FOR_EACH_CONST(i, Vector<ImportModule *>, importedModules)(*i)->donateOps(this);
    }
    //
...
ImportModule::donateOps(ImportModule *importer) {
    ...
    //	must be bound.
    //
    FOR_EACH_CONST(i, Vector<ImportModule *>, importedModules)(*i)->donateOps(importer);
    //
...
ImportModule::fixUpImportedOps() {
    ...
    {
        FOR_EACH_CONST(i, Vector<ImportModule *>, parameterTheories)(*i)->fixUpDonatedOps(this);
    }
    //
    //	We now go through our regular imports and ask them to
    ...
    //
    {
        FOR_EACH_CONST(i, Vector<ImportModule *>, importedModules)(*i)->fixUpDonatedOps(this);
    }
}
...
ImportModule::fixUpDonatedOps(ImportModule *importer) {
    ...
    //	must be bound.
    //
    FOR_EACH_CONST(i, Vector<ImportModule *>, importedModules)(*i)->fixUpDonatedOps(importer);
    //
...
ImportModule::importStatements() {
    ...
    //
    {
        FOR_EACH_CONST(i, Vector<ImportModule *>, parameterTheories)(*i)->donateStatements(this);
    }
    //
    //	We now go through our regular imports and ask them to
    ...
    //
    {
        FOR_EACH_CONST(i, Vector<ImportModule *>, importedModules)(*i)->donateStatements(this);
    }
}
...
ImportModule::donateStatements(ImportModule *importer) {
    ...
    //	must be bound.
    //
    FOR_EACH_CONST(i, Vector<ImportModule *>, importedModules)(*i)->donateStatements(importer);
    //
